    ...
    return (
        ...
        >
            <div className="text-center space-y-4 z-10">
                ...
                <Element id="hero_images" is={UserContainer} background="transparent" layoutMode="flex" flexDirection="row" gap={40} alignItems="center" justifyContent="center" padding={40}>
                    <div className="flex flex-col items-center gap-2">
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white/80 shadow-lg">
                            <Element id="bride_img" is={UserImage} width="100%" height="100%" src="https://placehold.co/150/d4a5a5/white?text=S" />
                        </div>
                        <UserText text="Sarah Johnson" fontSize={20} color="#ffffff" fontFamily="'Playfair Display', serif" />
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <UserText text="Michael Chen" fontSize={20} color="#ffffff" fontFamily="'Playfair Display', serif" />
                    </div>
                </Element>
            </div>
        </div>
